        ...
        <div className=" min-h-screen w-full max-w-[700px] pt-6">
            <main className=" w-full flex flex-col items-center px-3">
                <div className="mt-6 space-y-3 w-full flex items-center justify-center">
                    <div className="flex w-full rounded-[12px] p-[2px] h-[40px] border border-[#ffffff14] bg-[#ffffff0a] text-[15px]">
                        <input type="radio" name="tab" id="frames" className="hidden peer/frames" defaultChecked />
                        <input type="radio" name="tab" id="elements" className="hidden peer/elements" />
                        <input type="radio" name="tab" id="effects" className="hidden peer/effects" />

                        <label
                            htmlFor="frames"
                            className="flex-1 flex items-center justify-center rounded-[10px] cursor-pointer transition-all bg-transparent peer-checked/frames:bg-gradient-to-r peer-checked/frames:from-[#5afaaf1f] peer-checked/frames:to-[#1fcbff1f]"
                        >
                            <span className="font-medium text-white peer-checked/frames:bg-gradient-to-r peer-checked/frames:from-[#A4FE28] peer-checked/frames:via-[#7DF7C7] peer-checked/frames:to-[#4AD6FC] peer-checked/frames:bg-clip-text peer-checked/frames:text-transparent">
                                Frames
                            </span>
                        </label>
                        ...
                        <label
                            htmlFor="elements"
                            className="flex-1 flex items-center justify-center rounded-[10px] cursor-pointer transition-all bg-transparent peer-checked/elements:bg-gradient-to-r peer-checked/elements:from-[#5afaaf1f] peer-checked/elements:to-[#1fcbff1f]"
                        >
                            <span className="font-medium text-white peer-checked/elements:bg-gradient-to-r peer-checked/elements:from-[#A4FE28] peer-checked/elements:via-[#7DF7C7] peer-checked/elements:to-[#4AD6FC] peer-checked/elements:bg-clip-text peer-checked/elements:text-transparent">
                                Elements
                            </span>
                        </label>
                        ...
                        <label
                            htmlFor="effects"
                            className="flex-1 flex items-center justify-center rounded-[10px] cursor-pointer transition-all bg-transparent peer-checked/effects:bg-gradient-to-r peer-checked/effects:from-[#5afaaf1f] peer-checked/effects:to-[#1fcbff1f]"
                        >
                            <span className="font-medium text-white peer-checked/effects:bg-gradient-to-r peer-checked/effects:from-[#A4FE28] peer-checked/effects:via-[#7DF7C7] peer-checked/effects:to-[#4AD6FC] peer-checked/effects:bg-clip-text peer-checked/effects:text-transparent">
                                Effects
                            </span>
                        </label>
                    </div>
                ...
                <div className="mt-6 space-y-3 w-full">
                    <div className="border border-[#ffffff14] rounded-[16px] p-4 bg-gradient-to-b from-[#2b444799] via-[#171c24] to-[#182129] space-y-4">
                        <span className="text-[12px] text-[#727485]">JPG / PNG files up to 10MB with minimum dimensions of 300px</span>
                        <div className="rounded-[8px] bg-[#0D1116] h-[180px] flex flex-col items-center justify-center cursor-pointer">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="bg-gradient-to-r from-[#A4FE28] via-[#7DF7C7] to-[#4AD6FC] bg-clip-text text-transparent">Click / Drop / Paste</span>
                            </div>
                        ...
                        <div className="flex justify-between items-center">
                            <div className="flex items-center gap-[6px] font-medium">
                                <span className="text-white">Prompt <span className="text-[#727485]">(optional)</span></span>
                            </div>
                            <div className="flex items-center gap-[6px] font-medium">
                ...
                <div className="mt-6 space-y-3 w-full">
                    <div className="border border-[#ffffff14] rounded-[16px] p-4 bg-gradient-to-b from-[#2b444799] via-[#171c24] to-[#182129] space-y-4">
                        <div className="flex items-center gap-[6px] font-medium">
                            ...
                            <span className="text-white">Motion Brush</span>
                            <span className="text-[#727485] text-[12px]">(Control the Movement of Objects)</span>
                        </div>
                        <textarea className="border border-transparent rounded-[10px] text-[14px] py-3 px-4 w-full resize-none bg-[#0D1116] h-[72px] outline-none placeholder:text-[#727485]" placeholder="Currently unavailable on MEOW 1.6, please switch to MEOW 1.5">
                ...
                <div className="mt-6 space-y-3 w-full">
                    <div className="border border-[#ffffff14] rounded-[16px] p-4 bg-gradient-to-b from-[#2b444799] via-[#171c24] to-[#182129] space-y-4">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <input id="creativity" className="flex-1" type="range" name="creativity" defaultValue="50" />
                        ...
                        <div className="space-y-2">
                            ...
                            <input id="count" className="w-full" type="range" name="count" defaultValue="50"></input>
                        </div>
                    </div>
                </div>
                <div className="mt-6 space-y-3 w-full">
                    <div className="border border-[#ffffff14] rounded-[16px] p-4 bg-gradient-to-b from-[#2b444799] via-[#171c24] to-[#182129] space-y-4">
                        ...
                        <textarea className="border border-transparent rounded-[10px] text-[14px] text-white pt-3 px-4 w-full resize-none bg-[#0d1116]
