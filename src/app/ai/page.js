            ...
            <main className=" w-full flex flex-col items-center px-3 ">
                <div className="mt-6 space-y-3 w-full">
                    <div className="border border-[#ffffff14] rounded-[16px] p-4 bg-gradient-to-b from-[#2b444799] via-[#171c24] to-[#182129] space-y-4">
                        ...
                        h-[156px] outline-none placeholder:text-[#727485]" placeholder="Please describe your creative ideas for the image, or view Help Center for a quick start.">
                        </textarea>
                ...
                <div className="mt-6 space-y-3 w-full">
                    <div className="border border-[#ffffff14] rounded-[16px] p-4 bg-gradient-to-b from-[#2b444799] via-[#171c24] to-[#182129] space-y-4">
                        <div className="flex items-center gap-[6px] font-medium">
                            ...
                            <span className="text-white mr-3">Upload a Reference <span className="text-[#727485]">(optional)</span></span>
                        ...
                        <div className="text-[12px] text-[#e5e7eb]">Higher Face Reference means more reference to the face of the subject</div>
                        <div className="rounded-[8px] bg-[#0d1116] h-[128px] flex flex-col items-center justify-center cursor-pointer">
                            ...
                            <span className="text-[12px] text-[#727485]">Support JPG/PNG Files</span>
                        </div>
                    </div>
                </div>
                <div className="mt-6 space-y-3 w-full">
                    <div className="border border-[#ffffff14] rounded-[16px] p-4 bg-gradient-to-b from-[#2b444799] via-[#171c24] to-[#182129] space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex flex-wrap gap-x-4 gap-y-2">
                                ...
                                <div className="space-y-2 cursor-pointer group">
                                    <div className="flex items-center justify-center w-12 gap-2 h-7">
                                        <div className="border-2 w-7 h-[21px] rounded-[6px] transition-colors duration-200 group-hover:border-[#72e528]"></div>
                                    </div>
                                    <div className="text-center text-[12px] text-white transition-colors duration-200 group-hover:text-[#72e528]">4:3</div>
                                </div>
                                <div className="space-y-2 cursor-pointer group">
                                    <div className="flex items-center justify-center w-12 gap-2 h-7">
                                        <div className="border-2 w-7 h-[18.66px] rounded-[6px] transition-colors duration-200 group-hover:border-[#72e528]"></div>
                                    </div>
                                    <div className="text-center text-[12px] text-white transition-colors duration-200 group-hover:text-[#72e528]">3:2</div>
                                </div>
                                <div className="space-y-2 cursor-pointer group">
                                    <div className="flex items-center justify-center w-12 gap-2 h-7">
                                ...
                                <div className="space-y-2 cursor-pointer group">
                                    <div className="flex items-center justify-center w-12 gap-2 h-7">
                                        <div className="border-2 w-7 h-3 rounded-[6px] transition-colors duration-200 group-hover:border-[#72e528]"></div>
                                    </div>
                                    <div className="text-center text-[12px] text-white transition-colors duration-200 group-hover:text-[#72e528]">21:9</div>
                                </div>
                            </div>
                        </div>
                        <div className="space-y-2">
